...
service_opts = [
    ...
    cfg.IntOpt('simultaneous_creation_limit',
               default=5,
               help='Number of resources that are created in the same time.'),
    cfg.BoolOpt('ignore_resource_failures',
                default=False,
                help='Ignore resource failures.'),
    cfg.BoolOpt('abandon_failed_resource',
                default=True,
                help='Abandon failed resources instead deleteing them.'),
